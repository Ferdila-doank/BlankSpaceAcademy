...
with DAG('DAG_02', description='Python DAG', schedule_interval='23 23 * * *', start_date=datetime(2021, 2, 22), catchup=False) as dag:
	python_task1 = bash_operator.BashOperator(
        ...
        bash_command='python3 /home/airflow/gcs/data/GCP/case02.py',
	)